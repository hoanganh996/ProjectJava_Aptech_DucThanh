<%-- 
    Document   : checkout
    Created on : Aug 21, 2018, 11:35:49 PM
    Author     : panth
--%>
                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            ...
                            <h2><a href="single-product.html">IPhong7 256GB</a></h2>
                            <div class="product-sidebar-price">
                                <ins>$500.00</ins> <del>$250.00</del>
                            </div>                             
                        </div>
                        <div class="thubmnail-recent">
                            <img src="img/xiaomi-mi-a1-vang-hong-190x190.jpg" class="recent-thumb" alt="">
                            <h2><a href="single-product.html">Xiaomi Mi a1</a></h2>
                            <div class="product-sidebar-price">
                                <ins>$300.00</ins> <del>$120.00</del>
                            </div>                             
                        </div>
                        <div class="thubmnail-recent">
                            <img src="img/sony-xperia-z3.jpg" class="recent-thumb" alt="">
                            <h2><a href="single-product.html">Sony Experia Z3</a></h2>
                            <div class="product-sidebar-price">
                                <ins>$400.00</ins> <del>$100.00</del>
                            </div>                             
                        </div>
                        <div class="thubmnail-recent">
                            <img src="img/oppo-f7-1-400x400-190x190.jpg" class="recent-thumb" alt="">
                            <h2><a href="single-product.html">Oppo F7</a></h2>
                            <div class="product-sidebar-price">
                                <ins>$450.00</ins> <del>$250.00</del>
                            </div>                             
                        </div>
                    </div>
